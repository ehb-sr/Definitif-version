            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">Welkom op de studentenraad admin panel!</h1>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <img img src="{{ asset('img/admin/quote.png') }}" class="comment">
                            <a href="/adminOverzichtCitaat" id="adminOverzichtCitaat">
                                <h5>{{$citatencount}} Citaten</h5>
                    ...
                    <div class="col-md-4">
                        ...
                        <img img src="{{ asset('img/admin/stuvers.png') }}" class="comment">
                           <a href="/adminOverzichtStuver" id="adminOverzichtStuver">
                               <h5>{{$stuverscount}} Stuvers</h5>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="main-box mb-red">
                        <img img src="{{ asset('img/admin/raden.png') }}" class="comment">
                            <a href="/adminOverzichtRaden" id="adminOverzichtRaden">
                              <h5>{{$radencount}} Raden</h5>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4">
                                            <div class="main-box mb-dull">
                                             <img img src="{{ asset('img/admin/dossier.png') }}" class="comment">
                                              <a href="/adminOverzichtDossier" id="adminOverzichtDossier">

                                                  <h5>{{$dossierscount}} Dossier(s)</h5>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                                                    <div class="main-box mb-red">
                                                                                    <img img src="{{ asset('img/admin/comment.png') }}" class="comment">
                                                                                        <a href="/adminOverzichtComment" id="adminOverzichtComment">
