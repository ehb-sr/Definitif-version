   ...
   <nav class="navbar-default navbar-side" role="navigation">
        ...
        <div id="page-wrapper">
                    <div id="page-inner">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="page-head-line">Dossier aanmaken</h1>
                            </div>
                        </div>
                        <!-- /. ROW  -->
                        <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                       <div class="panel panel-info">
                                ...
                                Dossier aanmaken form
                                </div>
                                <div class="panel-body">
                                    {{  Form::open(array('action'=>'DossierAdminController@create', 'method' => 'post', 'enctype="multipart/form-data"')) }}
                                                <div class="form-group">
                                                    <label>Jaar</label>
                                                    <input class="form-control" type="text" name="jaar" placeholder="jaar" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Titel</label>
                                                    <input class="form-control" type="text" name="titel" placeholder="titel" required>
                                                </div>
                                         <div class="form-group">
                                                    <label>Topic</label>
                                                ...
                                                <div class="form-group">
                                                    <label>Pdf</label><br>
                                                    <input type="file" name="pdf" placeholder="pdf" required>
                                                 </div>
                                                    <div >
                                                        <label>Einde</label>
                                                    <input class="form-control" type="dateTime" name="einde" required>
                                                </div>
