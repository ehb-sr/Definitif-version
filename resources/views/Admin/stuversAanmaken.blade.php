                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                       <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    {{  Form::open(array('action'=>'StuversAdminController@create', 'method' => 'post')) }}
                                                                             ...
                                                                             <div class="form-group">
                                                                                     ...
                                                                                     <div class="form-group">
                                                                                       <label>Jaar</label>
                                                                                       <input class="form-control" type="number" name="Jaar" placeholder="Jaar">
                                                                                     </div>
                                                                                      <div class="form-group">
                                                                                      <label>Campus</label>
                                                                                      <input class="form-control" type="text" name="Campus" placeholder="Campus">
                                                                                      </div>
                                                                                    <div class="form-group">
                                                                                        <label>Statuut</label>
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                        <label>Quote</label>
                                                                                        <textarea class="form-control" rows="3" type="text" name="Quote" placeholder="Quote"></textarea>
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                      <label>Email</label>
