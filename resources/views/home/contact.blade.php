<div class="flex" id="contactContent">
    <a href="https://www.facebook.com/Studentenraad-Erasmushogeschool-Brussel-1413231898922199/" target="_blank">
        <div class="card" >
    ...
    <a href="mailto:studentenraad@ehb.be" target="_blank">
        <div class="card">
