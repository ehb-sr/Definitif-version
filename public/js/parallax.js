                ...
                $(options.photowrap).each(function(){
                    ...
                    if ((elem.top < viewport.bottom) && (elem.bottom > viewport.top)){
                        if(prefix != null){
                            ...
                            $(".scroll-holder[data-index='" + index + "']").css("transform","translate3D(0, " +  translateY + "px,0)").css("visibility","visible");
                            $(".scroll-holder[data-index='" + index + "']").find('img').css("transform","translate3D(0, " +  -(translateY) * options.speed + "px,0)");
